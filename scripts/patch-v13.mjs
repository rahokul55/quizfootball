...
rw('v13.css',s=>{
  ...
  const guard='/* V13_2_MATCH_OVERLAY_GUARD */';
  if(!s.includes(guard))s+=`\n${guard}\nbody.v13-match-active #v9Office,body.v13-match-active .v9-office{display:none!important;visibility:hidden!important;opacity:0!important;pointer-events:none!important}\nbody.v13-match-active #v13MatchCanvas3D{display:block!important;visibility:visible!important;opacity:1!important}\n`;
  return s;
});
rw('sw-v5.js',s=>{
  s=s.replace(/const CACHE='quizfootball-[^']+'/,"const CACHE='quizfootball-v13.2.1'");
...
console.log('V13.2.1 production wiring applied: authoritative visible 3D, overlay guard, adaptive quality, slower single-call commentator, larger readable UI and cache busting.');
